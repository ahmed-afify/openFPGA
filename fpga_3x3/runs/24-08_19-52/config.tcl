...
set ::env(CELL_PAD) 8
set ::env(MERGED_LEF) /openLANE_flow/designs/fpga_3x3/runs/24-08_19-52//tmp//merged.lef
set ::env(MERGED_LEF_UNPADDED) /openLANE_flow/designs/fpga_3x3/runs/24-08_19-52//tmp//merged_unpadded.lef
set ::env(TRACKS_INFO_FILE) /openLANE_flow/designs/fpga_3x3/runs/24-08_19-52//tmp//tracks_copy.info
set ::env(TECH_LEF) /home/aa/Desktop/Afify/openlane/pdks/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef
# Design config
set ::env(CLOCK_PERIOD) 10
# Synthesis config
set ::env(LIB_SYNTH) /openLANE_flow/designs/fpga_3x3/runs/24-08_19-52//tmp//trimmed.lib
